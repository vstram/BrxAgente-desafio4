...
export function AddHistoricalData(arg1:models.HistoricalVRData):Promise<void>;
...
export function GenerateForecast(arg1:string,arg2:number):Promise<models.ConsumptionForecast>;
...
export function GetHistoricalData():Promise<Array<models.HistoricalVRData>>;
...
export function PredictTrends(arg1:string):Promise<models.Prediction>;
